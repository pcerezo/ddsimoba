...
-- Tiempo de generación: 24-12-2019 a las 02:14:05
...
CREATE TABLE `cuentapertenece` (
  ...
  `contrasena` char(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `correo` char(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `denuncia` (
  `nombrec1` char(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `nombrec2` char(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `fecha` date NOT NULL,
...
CREATE TABLE `equipo` (
  `idequipo` smallint(6) NOT NULL,
  `nombreequipo` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `objetoscuenta` (
  `nombrec` char(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `partida` (
  `idpartida` tinyint(4) NOT NULL,
  `tipo` char(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
--
ALTER TABLE `partida`
  MODIFY `idpartida` tinyint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `juega`
  ADD CONSTRAINT `juega_ibfk_1` FOREIGN KEY (`idpartida`) REFERENCES `partida` (`idpartida`) ON DELETE RESTRICT ON UPDATE RESTRICT,
